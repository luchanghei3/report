...
if __name__ == "__main__":
    ...
    elements.append(SectionTitle("检测结果详情", number=5, x=0, y=0))
    elements.append(Spacer(1, 50))
    elements.append(SectionSubtitle("5.1 核心建议", x=0, y=0))
    ...
    elements.append(Paragraph(core_advice_text, subtitle_text_style))

    elements.append(Spacer(1, 50))  # 可选：段落下方空白
    elements.append(SectionSubtitle("5.2 个体化健康管理建议", x=0, y=0))

    # 插入图片
    img_advice_path = BASE_DIR / "advice.png"
